...
import { gastosComun } from '../../utils/data/gastosComunes';

const PlaceDetailScreen = () => {

    const pagar = () => {
        console.warn("proceso de pago")
    }
                                     ...
                                     <View style={{ flex: 3, marginTop:20  }} >
                                        ...
                                        <View style={{ flexDirection: 'column' }}>    
                                                <View style={{ flexDirection: 'row' }}>
                                                    ...
                                                    <View style={{ flex: 3, backgroundColor: '#ffffff', padding: 1 }} >
                                                        <Text style={styles.textpago}> Total: </Text>
                                                    </View>
                                                    <View style={{ flex: 6, backgroundColor: '#ffffff', padding: 1 }}>
                                                            <Text style={styles.textpago}>{item.totalgastos}</Text>
                                                    </View>
                                                    <View style={{ flex: 0.5 }}></View>
                                                </View> 
                                    </View>
